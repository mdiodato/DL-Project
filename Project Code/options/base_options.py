...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='label2wikiart', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='./datasets/wikiart/')
        parser.add_argument('--image_dir', type=str, default='./datasets/wikiart/train_img')
        parser.add_argument('--label_dir', type=str, default='./datasets/wikiart/train_label')
        parser.add_argument('--dataset_mode', type=str, default='wikiart')
