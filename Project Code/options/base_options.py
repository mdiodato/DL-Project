...
class BaseOptions():
    ...
    def initialize(self, parser):
		...
		parser.add_argument('--image_dir_guide', type=str, default='./datasets/wikiart_all/')
        parser.add_argument('--label_dir', type=str, default='./datasets/wikiart_all/')
        parser.add_argument('--filter_cat_real', type=str, default='genre')
        parser.add_argument('--filter_values_real', nargs ='+', default=['landscape'])
		parser.add_argument('--filter_cat_guide', type=str, default='style')
        parser.add_argument('--filter_values_guide', nargs ='+', default=['impressionism'])
