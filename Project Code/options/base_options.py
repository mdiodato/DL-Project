...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='label2wikiart-all', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='./datasets/wikiart_all/')
        parser.add_argument('--image_dir_real', type=str, default='./datasets/wikiart_all/')
        parser.add_argument('--image_dir_guide', type=str, default='./datasets/coco/')
        parser.add_argument('--label_dir', type=str, default='./datasets/wikiart_all/')
        parser.add_argument('--filter_cat_real', type=str, default='style')
        parser.add_argument('--filter_values_real', nargs ='+', default=['landscape'])
        parser.add_argument('--filter_cat_guide', type=str, default='Super Category')
        parser.add_argument('--filter_values_guide', nargs ='+', default=['person', 'outdoor', 'animal'])
        parser.add_argument('--test_load', action='store_false', help='test the images open when initiating the dataloader')
